...
v1_api_urls = [
    re_path(
        rf"^tasks/{COURSE_ID_PATTERN}$",
        api.InstructorTasks.as_view(),
        name="list_instructor_tasks",
    ),
    re_path(
        rf"^reports/{COURSE_ID_PATTERN}$",
        api.ReportDownloads.as_view(),
        name="list_report_downloads",
    ),
    re_path(
        rf"^reports/{COURSE_ID_PATTERN}/generate/problem_responses$",
        api.ProblemResponseReportInitiate.as_view(),
...
urlpatterns = [
    ...
    path(
        ...
        api.update_forum_role_membership,
    ...
    path(
        ...
        api.get_proctored_exam_results,
        name="get_proctored_exam_results",
    ),
    # Grade downloads...
    path(
        "list_report_downloads", api.list_report_downloads, name="list_report_downloads"
    ),
    ...
    path(
        ...
        api.get_course_survey_results,
        name="get_course_survey_results",
    ),
    ...
    path(
        ...
        api.export_ora2_submission_files,
    ...
    path(
        ...
        api.enable_certificate_generation,
        name="enable_certificate_generation",
    ),
    path(
        "start_certificate_generation",
        api.start_certificate_generation,
        name="start_certificate_generation",
    ),
    path(
        "start_certificate_regeneration",
        api.start_certificate_regeneration,
        name="start_certificate_regeneration",
    ),
    path(
        "certificate_exception_view/",
        api.certificate_exception_view,
        name="certificate_exception_view",
    ),
    re_path(
        r"^generate_certificate_exceptions/(?P<generate_for>[^/]*)",
        api.generate_certificate_exceptions,
        name="generate_certificate_exceptions",
    ),
    path(
        "generate_bulk_certificate_exceptions",
        api.generate_bulk_certificate_exceptions,
        name="generate_bulk_certificate_exceptions",
    ),
    path(
        "certificate_invalidation_view/",
        api.certificate_invalidation_view,
        name="certificate_invalidation_view",
    ),
    path("get_sga_report/", api.get_sga_report, name="get_sga_report"),
    path("get_sga_report_data/", api.get_sga_report_data, name="get_sga_report_data"),
    path("get_grade_book_data/", api.get_grade_book_data, name="get_grade_book_data"),
    path("get_gradebook_report/", api.get_gradebook_report, name="get_gradebook_report"),
]
